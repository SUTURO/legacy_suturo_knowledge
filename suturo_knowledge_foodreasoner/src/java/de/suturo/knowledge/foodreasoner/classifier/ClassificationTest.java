...
public class ClassificationTest {
	...
	mapCoords.clear();
	odomCoords.clear();
	PerceivedObject[] pos = cluster.getClusters().toArray(new PerceivedObject[0]);
    ...
    private static void addTransformPoint(String target, Stamped<Point3d> in, Map<Long, Stamped<Point3d>> map, long cID) {
	try {
