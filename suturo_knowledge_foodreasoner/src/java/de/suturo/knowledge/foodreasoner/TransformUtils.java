...
/**
 * Holds transformation utils for easy conversion between ROS message types, javax.vecmath objects and Prolog in/output.
 * 
 * @author Moritz
 * 
 */
public class TransformUtils {
	...
	Vector3d vec = new Vector3d(pose.position.x, pose.position.y, pose.position.z);
    ...
    /**
     * Utility method to convert a PerceivedObject centroid to Stamped&lt;Point3d&gt; object
     * 
     * @param po
    ...
    /**
     * Utility method to convert a PerceivedObject cuboid pose to Stamped&lt;Matrix4d&gt; object
     * 
     * @param po
     *            PerceivedObject object
     * @return Stamped&lt;Point3d&gt; object
