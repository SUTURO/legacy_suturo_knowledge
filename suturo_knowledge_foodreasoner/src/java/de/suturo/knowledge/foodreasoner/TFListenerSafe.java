...
/**
 * This provides a TFListener which will work in rosjava environments used in rosprolog environments that are launched
 * with json_prolog.<br/>
...
public class TFListenerSafe extends TFListener {
	...
	try {
	    ...
	    BufferedReader br = new BufferedReader(new InputStreamReader(rospack.getInputStream()));
	    String line;
