...
/**
* Calls Perception Service, parses respective barcoo page and returns nutritional values
*/
    public List<PerceivedObject> getBarcode() throws RosException, MalformedURLException, IOException{
        String barcode = callService(Operation.GET);
        ...
        try 
        {
            Scanner scanner = new Scanner(new URL("http://www.barcoo.com/"+barcode+"?source=pb").openStream());
