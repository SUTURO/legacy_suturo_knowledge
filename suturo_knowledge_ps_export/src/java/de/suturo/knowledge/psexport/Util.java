...
/**
 * Provide util function for some abstraction helper methods to assist in using
 * (auto generated) rosjava stuff.
 * 
 * @author Moritz
 * 
 */
public final class Util {
     ...
     * @param w
     */
    public static void quatSetValue(Quaternion q, double x, double y, double z,
	    double w) {
	q.x = x;
	q.y = y;
	q.z = z;
     ...
     */
    public static Quaternion createMsgForQuaternion(double roll, double pitch,
	    double yaw) {
	...
	if (Math.abs(Util.quatLength2(q) - 1) > QUATERNION_TOLERANCE) {
