...
/**
 * Spawns a simple console which takes object attributes and spawns them in the
 * PlanningScene (currently only boxes). If an object name was used before, it
...
public class PSConsole {
	...
	private static CollisionObjectWrapper generateFromInput(String[] in) {
		CollisionObjectWrapper obj = new CollisionObjectWrapper(getArr(in, 0,
				"table"), Operation.ADD);
