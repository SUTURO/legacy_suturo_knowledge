...
public class GetClustersService {
    ...
    /**
     * Calls service with given operation and returns a list of perceived objects
     * 
     * @param op
     *            Operation
     * 
	...
	req.s = op.getOp();
	ServiceClient<Request, Response, GetClusters> cl = handle.serviceClient(serviceName, new GetClusters());
